...
function get_cicr16_eqs(; vm, ca_ss, ca_jsr, k_i, ca_o=2mM, k_o=5.4mM)
    @parameters begin
        A_LCC = 2
        B_LCC = 1/2
        ω_LCC = 0.01kHz
    ...
    vc1ca1 = A_LCC * γ * c1_lcc - B_LCC * ω * cca1_lcc
    vc2ca2 = A_LCC^2 * γ * c2_lcc - B_LCC^2 * ω * cca2_lcc
    vc3ca3 = A_LCC^3 * γ * c3_lcc - B_LCC^3 * ω * cca3_lcc
    vc4ca4 = A_LCC^4 * γ * c4_lcc - B_LCC^4 * ω * cca4_lcc
