...
function v_kgdh(akg, nad_m; ca_m, mg_m=400μM, ET_KGDH = 500μM, KCAT_KGDH = 50Hz, KM_AKG_KGDH = 1940μM, KM_NAD_KGDH = 38.7mM, KH1_KGDH = 0.04μM, KH2_KGDH = 0.07μM, KM_MG_KGDH = 30.8μM, KM_CA_KGDH = 0.15μM, NI_AKG_KGDH = 1.2)
...
function get_tca_sys(; atp_m, adp_m, nad_m, nadh_m, h_m, ca_m, pi_m=8mM, mg_m=0.4mM, use_mg=false, name=:tcasys)
    ...
    eqs = [
        ...
        vKGDH ~ v_kgdh(akg, nad_m; ca_m, mg_m, ET_KGDH, KCAT_KGDH, KM_AKG_KGDH, KM_NAD_KGDH, KH1_KGDH, KH2_KGDH, KM_MG_KGDH, KM_CA_KGDH, NI_AKG_KGDH),
