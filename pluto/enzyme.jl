...
# ╔═╡ 3d6f33de-b942-11f0-92a6-edbe9da6023b
begin
	using PlutoUI
	using Symbolics
	using LinearAlgebra
...
# ╔═╡ 5b551762-5203-480b-82bd-6123c1fb49cf
PlutoUI.TableOfContents()

# ╔═╡ 0285b161-52c3-4be8-b602-454a148836ea
...
# ╔═╡ c46e6ca7-bee8-4c45-a031-d0271a071dd2
...
# ╔═╡ 3e92d498-3b60-4da9-b47c-6fce0b6b1b8b
md"""
## SOD model
...
# ╔═╡ 482838cc-46f6-4efb-a353-72088c7f11d4
@variables k1 k3 k5 sox

# ╔═╡ 7457431f-258f-48d1-9959-e2a2c986d133
@time sol_sod = let
	k12 = k1 * sox
    k21 = k1 * sox
    k23 = k3 * sox
...
manifest_format = "2.0"
project_hash = "4c09efe8bfd43d013c2a898fe7699138303ee1ba"
